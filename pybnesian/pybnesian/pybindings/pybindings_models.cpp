...
In a SemiparametricBN network, the discrete nodes can only have discrete parents.
        ...
        .def(py::pickle([](const SemiparametricBNType& self) {
        return self.__getstate__(); },
                        [](py::tuple&) {
        return SemiparametricBNType::get(); }))
        .def(
            "spbn_from_pdag",
            &SemiparametricBNType::spbn_from_pdag,
            py::arg("df"),
            py::arg("pdag"),
...
:class:`CKDE <pybnesian.CKDE>` factors.
        ...
        .def(py::pickle([](const KDENetworkType& self) {
        return self.__getstate__(); },
                        [](py::tuple&) {
